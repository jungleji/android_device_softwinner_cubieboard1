...
public final class Utilities {
     ...
     * local definition
     */
    public static final int ACTION_START_ALL_APP_VIEW = 0;
    public static final int ACTION_START_SETTINGS = 1;
    public static final int ACTION_START_FAVORITES_APPS = 2;
    public static final int ACTION_START_FILEMANAGER = 3;
    public static final int ACTION_START_WEBBROWSER = 4;
    public static final int ACTION_COUNT = 5;
    
    public static final boolean DEBUG = false;
    
    public static final String ACTION_WEATHER_UPDATE = "com.softwinner.launcher.weather";    
    public static final String WEATHER_INFO_LOCATION = "weather_info_location";
    
    public static final String FILEMANAGER_PACKAGE = "com.softwinner.TvdFileManager";
    public static final String FILEMANAGER_NAME = "com.softwinner.TvdFileManager.MainUI";    
    public static final String FILEMANAGER_TYPE_MUSIC = "MEDIA_TYPE_MUSIC";
    public static final String FILEMANAGER_TYPE_PICTURE = "MEDIA_TYPE_PICTURE";
    public static final String FILEMANAGER_TYPE_VIDEO = "MEDIA_TYPE_VIDEO";
    public static final String FILEMANAGER_TYPE_ALL = "MEDIA_TYPE_ALL";
    
    public static final String ACTION_TVD_WIDGETS_PICKER = "com.softwinner.launcher.WIDGETS_PICKER";


    /**
     * icon relative method
     */
