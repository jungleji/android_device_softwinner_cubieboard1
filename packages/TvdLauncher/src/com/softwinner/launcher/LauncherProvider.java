...
import com.softwinner.launcher.LauncherSettings.Favorites;
...
public class LauncherProvider extends ContentProvider {
    ...
    static final String AUTHORITY = "com.softwinner.launcher.settings";
    
    static final String TABLE_FAVORITES = "favorites";
    static final String TABLE_FAVORITES_APP = "favorites_app";
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        private static final String TAG_FAVOIRTES_APP = "favorites_app";        
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            db.execSQL("CREATE TABLE favorites_app (" +
                    "_id INTEGER PRIMARY KEY," + 
                    "packageName TEXT," +
                    "className TEXT" +
                    ");");
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            {
            //TODO:if upgrade database , please restore other data from oldversion. 
            }
        ...
        private int loadFavorites(SQLiteDatabase db) {
            ...
            try {
                ...
                while (((type = parser.next()) != XmlPullParser.END_TAG ||
                    ...
                    } else if (TAG_FAVOIRTES_APP.equals(name)){
                        added = addFavoritesApp(db,a,packageManager);
                    }
        ...
        private boolean addFavoritesApp(SQLiteDatabase db, TypedArray a,PackageManager packageManager){
            ...
            try {            
                ...
                long num = db.insert(TABLE_FAVORITES_APP, null, values);
                Log.d(TAG, "favorites"+num);
            }catch(PackageManager.NameNotFoundException e){
                Log.w(TAG, "Unable to add favorite app to database: " + packageName +
                        "/" + className, e);
            }
            return true;
        }
